...
const TOOLS = [
  ...
  { name: "create_campaign", description: "Crea y envía una campaña con una plantilla aprobada (requiere confirm=true)" },
  { name: "get_campaign_stats", description: "Conteos de entrega por estado de una campaña" },
  { name: "get_campaign_logs", description: "Detalle de entrega por contacto de una campaña" },
  { name: "cancel_campaign", description: "Cancela una campaña programada" },
  ...
  { name: "search_labels", description: "Busca una etiqueta por nombre exacto" },
